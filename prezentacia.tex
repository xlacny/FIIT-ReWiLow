...
\begin{frame}{Stav Trhu LPWAN: Kto Kde Dominuje? \cite{iotanalytics2018_lpwan}}
  \begin{itemize}
    \item \textbf{LoRaWAN – Kráľ mimo Číny:} Dominuje v \textcolor{red}{EÚ} a \textcolor{red}{Sev. Amerike}.
    \item \textbf{NB-IoT – Čínsky gigant:} Palivo pre \textcolor{red}{smart-city} (84\% trhu).
    \item \textbf{LTE-M – Rýchly vyzývateľ:} Rast v \textcolor{red}{USA} a \textcolor{red}{EÚ}.
    \item \textbf{Sigfox – Nišový špecialista:} Stabilná voľba pre lacné senzory.
    \item \textbf{Záver:} Výber závisí od geografie – Čína → NB-IoT, USA → LTE-M, zvyšok sveta → LoRaWAN.
  \end{itemize}
\end{frame}
