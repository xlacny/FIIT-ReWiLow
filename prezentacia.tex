...
\begin{frame}{Trhové Trendy a Regionálna Vhodnosť LPWAN \cite{iotanalytics2018_lpwan}}
  \centering
  \setlength{\tabcolsep}{3pt}   % zmenší horizontálne medzery
  \renewcommand{\arraystretch}{0.9} % zmenší vertikálne medzery
  \scriptsize % menší font
  \begin{tabular}{p{2.2cm} p{3.2cm} c p{3.5cm}}
    \toprule
    ...
    LoRaWAN & Severná Amerika, EÚ, APAC & ~40\% (2023) & Líder mimo Číny \\
    Sigfox & EÚ, Japonsko, Brazília & Menší, stabilný & Pre lacné senzory \\
    \bottomrule
  \end{tabular}
\end{frame}
