...
\section*{\textbf{Charakteristika projektu}} % Upravené \bf
...
\subsection{Porovnanie LPWAN s inými modernými technológiami}
\label{sec:lpwan_vs_others}

\subsubsection*{Filozofia LPWAN}
\begin{itemize}
    \item Nie rýchlosť, ale úspora energie + pokrytie + životnosť. \cite{iotanalytics2018_lpwan}
\end{itemize}

\noindent
Väčšina LPWAN protokolov nedokáže podporovať aplikácie s vysokou šírkou pásma, ako je streamovanie videa alebo rozsiahle, rýchle prenosy dát. \textbf{LTE-M} napríklad ponúka vyššie rýchlosti dát, podporujúc \textit{Voice over LTE (VoLTE)} pre podnikové a priemyselné nasadenia.
...
\subsubsection{Detailný Prehľad Kľúčových LPWAN Protokolov}
...
\subsubsection{Dodatočne: Rozdiel medzi Wi-Fi HaLow a LPWAN}
...
\subsection{Rýchlosť prenosu dát}
...
\cite{iotanalytics2018_lpwan}
\noindent
\textbf{Myšlienka:} Nie nahradiť LPWAN, ale doplniť ho: vytvoriť univerzálny "most" pre systémy, ktoré vyžadujú obojsmernú komunikáciu, vyššiu rýchlosť a nižšiu spotrebu energie ako štandardné Wi-Fi.
...
\begin{table}[htbp]
    \cite{iotanalytics2018_lpwan}
    \centering
    \caption{Trhové Trendy a Regionálna Vhodnosť LPWAN}
    ...
    \begin{tabular}{l p{4cm} c p{5cm}}
        ...
        LoRaWAN & Sev. Amerika, EÚ, APAC & $\sim 40\%$ (2023), $\to 35\%$ (2027) & Líder mimo Číny, otvorený ekosystém \\
...
\begin{table}[htbp]
    \centering
    \caption{Hlavné Priemyselné Aplikácie LPWAN Technológií}
...
\noindent
%(Tu bude umiestnený text o perspektívach...)
\newpage
